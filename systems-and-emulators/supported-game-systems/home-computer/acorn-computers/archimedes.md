...
| ----------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| **File folder**         | :open\_file\_folder: roms \ :open\_file\_folder: archimedes                                                                                         |
| **File extension**      | .mfi .dfi .hfe .mfm .td0 .imd .d77 .d88 .1dd .cqm .cqi .dsk .ima .img .ufi .360 .ipf .adf .apd .jfd .ads .adm .adl .ssd .bbc .dsd .st .msa .zip .7z |
| **Group**               | MESS                                                                                                                                                |
| **Model emulated**      | aa4401, aa310, aa3000, aa540                                                                                                                        |
| **Softlists available** | archimedes                                                                                                                                          |
| **Media Types**         | floppy                                                                                                                                              |
...
| ------------------------ | ------- | --------- |
| aa310.zip                | `\bios` | See below |
| archimedes\_keyboard.zip | `\bios` | See below |
