...
In order to scrape only a single game, select the game and long-press the "south" button ![](.gitbook/assets/image.png) to open the game options. The select **SCRAPE.**
